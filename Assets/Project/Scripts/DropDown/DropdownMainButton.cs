...
public class DropdownMainButton : MonoBehaviour
{
    ...
    [Header("Navigation")]
    [Tooltip("If enabled, a correct answer on this dropdown will unlock page navigation.")]
    [SerializeField] private bool unlockNavigationOnCorrect = false;
    ...
    [Header("Events")]
    public UnityEvent OnCorrectValueEntered;
    ...
    {
        if (button != null)
            button.onClick.RemoveListener(OnMainClick);
    }
    ...
    private void OnMainClick()
    {
        ...
        if (currentPopup != null)
        {
            ...
            popupScript.ApplyAnimationSettings(
                direction,
                animDuration,
                distance);
        ...
        popupScript =
            currentPopup.GetComponent<DropdownPopup>();
        ...
        string text)
    {
        ...
        // =========================
        // CHOOSE FEEDBACK PREFAB
        // =========================

        GameObject prefab =
            isCorrect ? correctPrefab : wrongPrefab;
        ...
        if (prefab != null)
        {
            ...
            RectTransform feedbackRect =
                currentFeedback.GetComponent<RectTransform>();
            ...
            if (feedbackRect != null)
            {
                ...
                float xPos =
                    (halfWidth * directionMultiplier) +
                    (extraOffset * directionMultiplier);
        ...
        if (isCorrect)
        {
            // Unlock navigation ONLY if enabled
            // for this specific DropdownMainButton.
